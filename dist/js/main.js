...
//# sourceMappingURL=navigo.min.js.map
   ...
   function initComponents(){
      ...
      if(document.querySelectorAll('.animation-default').length > 0)
         sr.reveal('.animation-default', {duration: 1500});
